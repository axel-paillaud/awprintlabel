...
class AdminConfigurationController extends FrameworkBundleAdminController
{
    ...
    {
        $generalFormDataHandler = $this->get('axelweb.awprintlabel.form.general_form_data_handler');
        ...
        if ($generalForm->isSubmitted() && $generalForm->isValid()) {
            ...
            if (empty($errors)) {
                ...
                return $this->redirectToRoute('awprintlabel_form_configuration');
            }

            $this->flashErrors($errors);
        }

        return $this->render('@Modules/awprintlabel/views/templates/admin/form.html.twig', [
